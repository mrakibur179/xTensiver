...
const Footer = () => {
  return (
    <footer className="bg-whitezz text-gray-800 dark:bg-gray-900 dark:text-white px-6 pt-12 pb-4 border-t border-gray-200 dark:border-gray-800 transition-colors duration-300">
